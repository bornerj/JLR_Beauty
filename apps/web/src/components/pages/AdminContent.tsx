...
import DockerStatusModal from "../../modules/admin-docker-status/DockerStatusModal";
import { useDockerHealth } from "../../modules/admin-docker-status/useDockerHealth";
    ...
    <header className="admin-topbar">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <button
                ...
                onClick={() => setShowDockerModal((v) => !v)}
                style={{ background: "none", border: "1px solid #d4af37", borderRadius: "999px", padding: "0.35rem 0.65rem", cursor: "pointer", display: "flex", alignItems: "center", gap: "0.4rem", color: "#1b2f24" }}
            >
                <span className="material-symbols-outlined" style={{ fontSize: "1rem" }}>dns</span>
                <span
                    className={anyOffline ? "db-status-led db-status-led--offline" : "db-status-led db-status-led--online"}
                    aria-hidden="true"
                />
            </button>
