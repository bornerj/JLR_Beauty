...
export default function FranquiasMenu() {
                  ...
                  <div className="nav-links" id="submenu">
                      <div className="relative group">
                          ...
                          <div className="absolute left-0 top-full pt-3 w-[360px] opacity-0 invisible pointer-events-none group-hover:opacity-100 group-hover:visible group-hover:pointer-events-auto transition-all duration-200">
                              <div className="rounded-2xl bg-white shadow-2xl border border-forest/10 p-4">
                                  <div className="space-y-2">
                                      <a className="menu-item flex items-start gap-3 rounded-xl px-3 py-3 hover:bg-white/10 transition-colors" href="#models">
                                          <span className="size-10 rounded-xl bg-white/20 border border-gold/40 flex items-center justify-center text-forest">
                                              <span className="material-symbols-outlined text-lg">storefront</span>
                                          </span>
                                          <div>
                                              <p className="text-sm font-semibold text-primary">Modelos</p>
                                              <p className="text-xs text-primary/80">Formatos de franquia disponíveis.</p>
                                          </div>
                                      </a>
                                      <a className="menu-item flex items-start gap-3 rounded-xl px-3 py-3 hover:bg-white/10 transition-colors" href="#vision">
                                          <span className="size-10 rounded-xl bg-white/20 border border-gold/40 flex items-center justify-center text-forest">
                                              <span className="material-symbols-outlined text-lg">visibility</span>
                                          </span>
                                          <div>
                                              <p className="text-sm font-semibold text-primary">Visao</p>
                                              <p className="text-xs text-primary/80">O posicionamento da marca.</p>
                                          </div>
                                      </a>
                                      <a className="menu-item flex items-start gap-3 rounded-xl px-3 py-3 hover:bg-white/10 transition-colors" href="#contact">
                                          <span className="size-10 rounded-xl bg-white/20 border border-gold/40 flex items-center justify-center text-forest">
                                              <span className="material-symbols-outlined text-lg">handshake</span>
                                          </span>
                                          <div>
                                              <p className="text-sm font-semibold text-primary">Parceria</p>
                                              <p className="text-xs text-primary/80">{`Seja um parceiro ${branding.fullName}.`}</p>
                                          </div>
                                      </a>
                                  </div>
                                  <div className="mt-4 flex gap-2 border-t border-gold/30 pt-3">
                                      <a className="menu-item menu-item-btn flex-1 text-center text-[11px] font-bold uppercase tracking-widest py-2 rounded-lg bg-gold text-forest hover:bg-gold/90 transition-colors" href="#menusuperior">Oportunidade</a>
                                      <a className="menu-item flex-1 text-center text-[11px] font-bold uppercase tracking-widest py-2 rounded-lg border border-gold/60 text-forest hover:bg-gold/10 transition-colors" href="#contact">Seja Parceiro</a>
                                  </div>
                              </div>
                          </div>
                      </div>
                          ...
                          <details className="lg:hidden relative">
                            ...
                            >
                              <div className="px-5 py-4 flex flex-col gap-3">
                                ...
                                <Link className="nav-link menu-item" to="/franquias#models">Modelos de franquia</Link>
                                <Link className="nav-link menu-item" to="/franquias#vision">Visao da marca</Link>
